    ...
    {  
		...
		using (WebClient client = new WebClient())
		{
			...
			try {
				...
				{
					Console.WriteLine("Server is up to date! Now exiting...");
					Thread.Sleep(2000);
					return;
				}
			} catch {
				Console.WriteLine("Current Version not found! Updating anyway...\n");
			}
			File.WriteAllText("version.txt", version);
			
			Console.WriteLine("Downloading new server...");
			client.DownloadFile(link, "server.temp");
			Console.WriteLine("Finished Downloading\n");
		}
		
		Console.WriteLine("Extracting new server...");
		...
		Console.WriteLine("Finished! Now exiting...\n");
